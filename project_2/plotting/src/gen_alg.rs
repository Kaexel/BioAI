...
pub struct Island<'a, S, P, I> {
    gen_alg: GenAlg<'a, S, P>,
    population: Vec<I>,
    pop_size: usize,

}

impl<'a, S, P, I> Island<'a, S, P, I>
where S: Selection, P: ParentSelection, I: Individual
{
    pub fn new(gen_alg: GenAlg<'a, S, P>,
               population: Vec<I>,
               pop_size: usize,
