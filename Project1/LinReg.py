...
print(l.get_fitness(g, Y))
print(l.get_fitness(l.get_columns(X, bs), Y))
print(g)
...
class SGA:
    def __init__(self, bitstring_size, max_generations, population_size, survivor_selection, parent_selection):
        ...
        self.fitness_function = self.sine_fitness
...
p = SGA(bitstring_size=101, max_generations=10, population_size=64, survivor_selection=SurvivorSelection.ELITISM, parent_selection=ParentSelection.TOURNAMENT)
crowding = SGA(bitstring_size=101, max_generations=10, population_size=64, survivor_selection=SurvivorSelection.CROWDING, parent_selection=ParentSelection.TOURNAMENT)
p.init_population()
p.generation_loop()
